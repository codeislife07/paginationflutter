...
void main() {
  group('Page requests', () {
    ...
    testWidgets('Requests first page only once', (tester) async {
      ...
      await _pumpPagedPageViewFlutter(
        tester: tester,
...
Future<void> _pumpPagedPageViewFlutter({
  ...
  Widget? noMoreItemsIndicator,
    ...
    tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: PagedPageViewFlutter<int, String>(
            pagingController: pagingController,
            scrollDirection: Axis.vertical,
            builderDelegate: PagedChildBuilderDelegate<String>(
              singleitemBuilder: _buildItem,
              newPageProgressIndicatorWidget: newPageProgressIndicator != null
