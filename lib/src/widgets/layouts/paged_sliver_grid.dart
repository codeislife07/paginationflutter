...
import 'package:scroll_pagination_flutter/src/widgets/layouts/paged_grid_view.dart';
  ...
  Widget build(BuildContext context) =>
      PagedLayoutBuilder<PageKeyType, ItemType>(
        ...
        completedListingBuilder: (
          ...
          singleitemBuilder: singleitemBuilder,
          itemCount: itemCount,
          appendixBuilder: noMoreItemsIndicatorWidget,
...
class _AppendedSliverGrid extends StatelessWidget {
  ...
  final IndexedWidgetBuilder singleitemBuilder;
  final int itemCount;
