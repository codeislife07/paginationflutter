...
typedef ErrorListingBuilder = Widget Function(
  ...
  IndexedWidgetBuilder itemWidgetBuilder,
  int itemCount,
  WidgetBuilder newPageErrorIndicatorWidget,
);
...
typedef LoadingListingBuilder = Widget Function(
  ...
  IndexedWidgetBuilder itemWidgetBuilder,
  int itemCount,
  WidgetBuilder newPageProgressIndicatorWidget,
);
...
/// [PagedGridView], [PagedMasonryGridView], or [PagedPageViewFlutter].
...
class _PagedLayoutBuilderState<PageKeyType, ItemType>
  ...
  WidgetBuilder get _firstPageErrorIndicatorWidget =>
      _builderDelegate.firstPageErrorIndicatorWidget ??
      (_) => FirstPageErrorIndicator(
            onTryAgain: _pagingController.retryLastFailedRequest,
          );

  WidgetBuilder get _newPageErrorIndicatorWidget =>
      _builderDelegate.newPageErrorIndicatorWidget ??
      (_) => NewPageErrorIndicator(
            onTap: _pagingController.retryLastFailedRequest,
          );

  WidgetBuilder get _firstPageProgressIndicatorWidget =>
      _builderDelegate.firstPageProgressIndicatorWidget ??
      (_) => FirstPageProgressIndicator();

  WidgetBuilder get _newPageProgressIndicatorWidget =>
      _builderDelegate.newPageProgressIndicatorWidget ??
      (_) => const NewPageProgressIndicator();

  WidgetBuilder get _noItemsFoundIndicatorWidget =>
      _builderDelegate.noItemsFoundIndicatorWidget ??
      (_) => NoItemsFoundIndicator();

  WidgetBuilder? get _noMoreItemsIndicatorWidget =>
      _builderDelegate.noMoreItemsIndicatorWidget;
            ...
            switch (pagingState.status) {
              case PagingStatus.ongoing:
                child = widget.loadingListingBuilder(
                  ...
                  _itemCount,
                  _newPageProgressIndicatorWidget,
                );
                break;
              ...
              case PagingStatus.subsequentPageError:
                child = widget.errorListingBuilder(
                  ...
                  _itemCount,
                  (context) => _newPageErrorIndicatorWidget(context),
                );
                break;
              case PagingStatus.noItemsFound:
                child = _FirstPageStatusIndicatorBuilder(
                  builder: _noItemsFoundIndicatorWidget,
                  shrinkWrap: _shrinkWrapFirstPageIndicators,
                  layoutProtocol: _layoutProtocol,
                );
                break;
              default:
                child = _FirstPageStatusIndicatorBuilder(
                  builder: _firstPageErrorIndicatorWidget,
                  shrinkWrap: _shrinkWrapFirstPageIndicators,
                  layoutProtocol: _layoutProtocol,
                );
            }
  ...
  Widget _buildListItemWidget(
    ...
    return _builderDelegate.singleitemBuilder(context, item, index);
  }
}
